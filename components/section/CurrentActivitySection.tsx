    ...
    <section className='py-10 relative text-white selection:bg-white selection:text-black'>
      <Container className={container({ size: 'large' })}>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <h1 className='font-bold uppercase tracking-widest text-xl'>Current&nbsp;Activity</h1>
        ...
        <div className='py-4 text-white/60 tracking-wide md:w-2/3 text-lg w-full space-y-4'>
          ...
          <p>I like to spend my time configuring my <a href='https://github.com/AdiCahyaSaputra/my-neovim-setup' className='text-sky-500 hover:underline'>IDE</a> and learning a lot about Linux. Currently I am using WSL 2 Ubuntu</p>
